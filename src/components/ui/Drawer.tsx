    ...
    <div className="fixed inset-0 z-50">
      ...
      >
        ...
        <div className="shrink-0 px-4 pt-4">
          ...
          {/* Close button leads, title 8px after it. No negative margins: the
              button's box — what the hover fill actually draws — is the
              content here, so it sits on the same 16px padding as everything
              else in the drawer and the gap is measured from it. Pulling the
              box out to align the × glyph instead put the fill under the
              title on one side and past the padding on the other. */}
          <div className="flex items-center gap-[8px] py-[4px]">
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-[4px] text-text-soft-400 transition-colors duration-100 ease-out hover:bg-bg-weak-50 hover:text-text-strong-950 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-text-strong-950"
            >
              <CloseIcon />
            </button>
